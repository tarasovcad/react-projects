...
export default function Card(props) {
    ...
    return (
        <div className="card">
            ...
            <button className={isAdded ? 'card__button--checked' : 'card__button'} onClick={onClickPlus}>
                <img src={isAdded ? "/img/btn-checked.svg" : "/img/plus.svg"}  alt="plus" width={11} height={11}/>
            </button>
            </div>
        </div>
    )
